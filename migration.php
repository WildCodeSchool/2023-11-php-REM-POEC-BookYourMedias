...
try {
    ...
    $pdo->exec('CREATE TABLE user (id INT PRIMARY KEY AUTO_INCREMENT, adresse_email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255), pseudo VARCHAR(45)  NOT NULL, role BOOLEAN NULL');
